    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div>
            ...
            Course Name<br><input type="text" placeholder="Name" id="Namecat1" name="" class="form-control"><br>
            Descprition<br><input type="text" placeholder="" id="desccat1" name="" class="form-control"><br>
            Duration<br><input type="text" placeholder="" id="desccat1" name="" class="form-control"><br>
            Course price<br><input type="text" placeholder="" id="desccat1" name="" class="form-control"><br>
            Sale price<br><input type="text" placeholder="" id="desccat1" name="" class="form-control"><br>
